---
title: "Google Stock Price Analysis"
...
Fitting ARIMA model on Google data and finding its accuracy in this part.
...
```
It recommends ARIMA(0, 0, 1) as the order of our arima model when we feed it the differenced series which is stationary. 
...
It recommends ARIMA(0, 1, 1) as the order of our arima model when we feed the non-stationary series into it. 
...
accuracy = 100 - MAPE = 100 - 1.003 = 98.9972
...
```
MAPE: mean average prediction error
accuracy = 100 - MAPE = 100 - 1.002764 = 98.9972
